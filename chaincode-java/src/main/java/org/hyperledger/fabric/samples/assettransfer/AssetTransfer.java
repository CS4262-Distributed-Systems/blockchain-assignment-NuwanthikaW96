...
public final class AssetTransfer implements ContractInterface {
 ...
 /**
     ...
     * @param duplicateAssetID the ID of the asset duplicated asset
     * @param owner the owner of the asset being duplicated
     * @return the duplicated asset
     */

    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String duplicateAssetID, final String owner) {
        Asset origAsset = ReadAsset(ctx, assetID);
        return CreateAsset(ctx, duplicateAssetID, origAsset.getColor(), origAsset.getSize(),
